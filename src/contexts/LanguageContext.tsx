...
const translations = {
  th: {
    ...
    'about.whoami': '$ whoami',
    'about.whoami.text': 'ผมชื่อ จิรวัฒน์ ทิพย์พินิจ (Jirawat Thipphinit)',
    'about.journey': '$ cat journey.txt',
    'about.journey.text': 'การเดินทางสู่โลกดิจิทัลของผมเริ่มต้นเมื่ออายุ 14 ปี จากความหลงใหลใน การสร้าง Server Minecraft เพื่อเล่นกับเพื่อนทำให้ผมต้องเรียนรู้ภาษาอังกฤษและอ่านเอกสาร Java มากมาย และฝึกฝนการแก้ปัญหา การทำงานกับ Skript และการอ่าน Javadocs เป็นประตูสู่ความเข้าใจในภาษา Java อย่างลึกซึ้ง',
    'about.passion': '$ echo $PASSION',
    'about.passion.text': 'ความหลงใหลในเกมพัฒนาไปสู่ความสนใจในการเขียนโปรแกรมอย่างลึกซึ้ง ผมชอบความท้าทายในการสร้างสิ่งต่างๆ ตั้งแต่เริ่มต้น ตั้งแต่การลองสร้างเว็บไซต์โรงเรียนเป็นงานแรกไปจนถึงการแข่งขันพัฒนาเว็บไซต์',
    ...
    'projects.website.description': 'ฝึกฝนทักษะ Front-end ด้วยการสร้างเว็บไซต์โรงเรียนที่ครอบคลุมและเข้าร่วมการแข่งขันสร้างเว็บไซต์ ถึงจะได้รางวัล อันดับที่ 2 แต่ก้ได้รับประสบการณ์การเรียนรู้มากมายจากการแข่งขันนี้',
    ...
    'contact.collaborate.desc': 'ผมกำลังมองหาโอกาสฝึกงาน Co-op ที่จะได้นำทักษะใน AI การพัฒนาเว็บ และวิศวกรรมซอฟต์แวร์มาใช้ ในขณะที่ได้เรียนรู้และเติบโตต่อไป ไม่ว่าคุณจะกำลังมองหาสมาชิกทีมที่ทุ่มเทหรือต้องการพูดคุยเรื่องโครงการ ผมยินดีที่จะรับฟังจากคุณ!',
